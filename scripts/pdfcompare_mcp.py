    ...
    try:
        ...
        return {
            ...
            "prompt_for_agent": (
                ...
                "и нужно ли объединять близкие bbox. Если пользователь не сказал про объединение, "
                "спроси явно; по умолчанию объединение выключено: bbox_merge_gap_mm=0. "
                "Для пробного объединения обычно предлагай bbox_merge_gap_mm=5; "
                "bbox_merge_max_area_ratio=16 и дополнительный page-area guard защищают от огромных пустых прямоугольников."
            ),
            "lang": lang,
        }
