...
HTML_REPORT_I18N: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "note_visual_changes": "Изменено ≈ {fg:.2f}% заполненного ({area:.1f} мм², зон: {n}, макс. зона: {max:.1f} мм²).",
        "note_visual_changes_sparse": "Изменения: {area:.1f} мм², зон: {n}, макс. зона: {max:.1f} мм².",
        "note_ecc_failed": "ECC-выравнивание не сошлось, сравнение выполнено без выравнивания.",
        "note_alignment_shift": "Автовыравнивание компенсировало смещение листа: X {x:+.2f} мм, Y {y:+.2f} мм.",
        "nav_sheet_word": "лист",
        "conf_exact": "точное",
    ...
    "en": {
        ...
        "note_visual_changes": "Changed ≈ {fg:.2f}% of drawn content ({area:.1f} mm², zones: {n}, max zone: {max:.1f} mm²).",
        "note_visual_changes_sparse": "Changes: {area:.1f} mm², zones: {n}, max zone: {max:.1f} mm².",
        "note_ecc_failed": "ECC alignment failed; comparison was performed without alignment.",
        "note_alignment_shift": "Automatic alignment compensated for a sheet offset: X {x:+.2f} mm, Y {y:+.2f} mm.",
