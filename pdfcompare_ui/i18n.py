...
I18N: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "pick_hint": "Выделите области мышкой (можно несколько). Esc — отмена. Координаты добавятся в поле «Исключить области» в формате x,y,w,h (проценты).",
        "btn_pick_exclude": "✏ Выбрать…",
        "status_pick_no_pdf": "Сначала выберите PDF.",
        "status_pick_added": "Добавлено областей: {count}.",
    ...
    "en": {
        ...
        "pick_hint": "Draw regions with the mouse (you can add several). Esc to cancel. Coordinates are appended to the exclude field as x,y,w,h (percent).",
        "btn_pick_exclude": "✏ Pick…",
        "status_pick_no_pdf": "Select a PDF first.",
        "status_pick_added": "Regions added: {count}.",
