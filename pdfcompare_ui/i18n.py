...
I18N: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "opts_exclude_hint": "Формат: x,y,w,h; например 70,80,30,20 — нижний правый штамп",
        ...
        "pick_title": "PDFCompare: выбрать исключаемые области",
    ...
    "en": {
        ...
        "opts_exclude_hint": "Format: x,y,w,h; example 70,80,30,20 for bottom-right title block",
        ...
        "pick_cancel": "Cancel",
        "pick_undo": "Undo last",
        "pick_title": "PDFCompare: select exclude regions",
