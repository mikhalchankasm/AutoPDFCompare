...
I18N: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "err_invalid_option_parse": "DPI и процессы должны быть целыми числами; допуск и области — числами.",
    ...
    "en": {
        ...
        "err_invalid_option_parse": "DPI and workers must be integers; tolerance and regions must be numeric.",
