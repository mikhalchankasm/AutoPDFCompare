...
- **MCP-сервер для AI-агентов** (Cursor, Claude Code, VS Code) — те же операции через инструменты агента, плюс опциональное описание реальных diff-зон через личный ключ DeepSeek или Qwen.
